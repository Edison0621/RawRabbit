...
namespace RawRabbit.Tests.Common
{
	public class NamingConventionsTests
	{
		...
		{
			/* Setup */
			string consoleAppUrl = @"\""Services\\Micro.Services.MagicMaker\\bin\\Micro.Services.MagicMaker.exe\"" ";

			/* Test */
			string consoleAppRes = NamingConventions.GetApplicationName(consoleAppUrl);
		...
		{
			/* Setup */
			string consoleAppUrl = @"\""Services\\Micro.Services.MagicMaker\\bin\\Micro.Services.MagicMaker.vshost.exe\"" ";
		...
		{
			/* Setup */
			string iisHostedApp = @"""c:\\windows\\system32\\inetsrv\\w3wp.exe -ap \""Application.Name\"" -v \""v4.0\"" -l \""webengine4.dll\"" -a \\\\.\\pipe\\iisipm6866bb0f-a36a-49b2-9ea8-d83ca69e873d -w \""\"" -m 0 -t 20 -ta 0""";

			/* Test */
			string iisHostedAppRes = NamingConventions.GetApplicationName(iisHostedApp);
		...
		{
			/* Setup */
			string iisHostedApp = @"""c:\\windows\\system32\\inetsrv\\w3wp.exe -ap \""Application.Name\"" -v \""v4.0\"" -l \""webengine4.dll\"" -a \\\\.\\pipe\\iisipm6866bb0f-a36a-49b2-9ea8-d83ca69e873d -h \""C:\\inetpub\\temp\\apppools\\voyager_dk\\voyager_dk.config\"" -w \""\"" -m 0 -t 20 -ta 0""";
		...
		public void Should_Be_Able_To_Get_Appllication_Name_From_Dot_Net_Core_Hosted_Apps()
		{
			...
			/* Test */
			string appName = NamingConventions.GetApplicationName(commandLime);
