...
{
	protected static readonly ConcurrentDictionary<IAsyncBasicConsumer, ConcurrentDictionary<string, TaskCompletionSource<BasicDeliverEventArgs>>> AllResponses = new();
	...
	public override async Task InvokeAsync(IPipeContext context, CancellationToken token = default(CancellationToken))
	{
		...
		TaskCompletionSource<BasicDeliverEventArgs> responseTsc = new();
